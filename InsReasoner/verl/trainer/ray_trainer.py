...
from verl.utils.checkpoint import find_latest_ckpt
from verl.utils.image_aug import augment_batch
...
class RayPPOTrainer:
    ...
    def _load_checkpoint(self) -> None:
        if self.config.trainer.load_checkpoint_path is not None:
            ...
            print("##########################++++++++come_find_last_checkpoint+++++++++#####################")
